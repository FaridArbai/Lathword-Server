...
PM_addContactReq::PM_addContactReq(string code){
	...
	cout << "VAMOS A DECODIFICAR ESTO : " + code << endl;
	...
	this->setFrom(from);				cout << "addCont:: from set to ->" + from <<endl;
	this->setContact(contact);		cout << "addCont:: contact set to ->"<<contact<<endl;
}
