...
PM_msg::PM_msg(string code){
	...
	this->setFrom(from);		cout << "msg:: from set to ->" + from <<endl;
	this->setTo(to);			cout << "msg:: to set to ->" + to <<endl;
	this->setDate(date);		cout << "msg:: date set to ->" + date <<endl;
	this->setMsg(msg);		cout << "msg:: msg set to ->" + msg<<endl;
}
